  ...
  publicMethods = {
    pushTag: function (tag, ignoreEvents, externalTagId) {
      ...
      */
      ...
      // check if restricted only to the tagList suggestions
      if(opts.onlyTagList){
      console.log("this function got initialized");  
      if(!opts.tagList){
        //console.log("this function got initialized");
      if($self.data().ttView){
      ...
      //if the list has been updated by look pushed tag in the tagList. if not found return
      if(opts.tagList){
      console.log("this function opts.tagList got initialized");  
      //var myArray = ["abstract algebra"];
      var suggestion = $.inArray(tag.toLowerCase(), opts.tagList);
      console.log("tag: " + tag.toLowerCase() + ", tagList: " + opts.tagList);      
